class ZCL_ZLMO_GW_004_DPC definition
  public
...
protected section.
  ...
  methods SCARRSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZLMO_GW_004_MPC=>TS_SCARR
    raising
  ...
  methods SCARRSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZLMO_GW_004_MPC=>TT_SCARR
...
CLASS ZCL_ZLMO_GW_004_DPC IMPLEMENTATION.
...
*&* This class has been generated on 04/09/2024 13:45:15 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZLMO_GW_004_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA scarrset_create_entity TYPE zcl_zlmo_gw_004_mpc=>ts_scarr.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA scarrset_get_entity TYPE zcl_zlmo_gw_004_mpc=>ts_scarr.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZLMO_GW_004_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA scarrset_get_entityset TYPE zcl_zlmo_gw_004_mpc=>tt_scarr.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA scarrset_update_entity TYPE zcl_zlmo_gw_004_mpc=>ts_scarr.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_ZCDS_LMO_003_1 TYPE zcds_lmo_003 ##NEEDED. " reference for where-used list

    DATA(lv_sadl_xml) =
               |<?xml version="1.0" encoding="utf-16"?>| &
               |<sadl:definition xmlns:sadl="http://sap.com/sap.nw.f.sadl" syntaxVersion="V2" >| &
               | <sadl:dataSource type="CDS" name="ScarrSet" binding="zcds_lmo_003" />| &
               |<sadl:resultSet>| &
