class ZCL_ZLMO_GW_010_01_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZLMO_GW_010_01_MPC========CP' ##NO_TEXT.
...
CLASS ZCL_ZLMO_GW_010_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZLMO_GW_010_SRV_01' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZLMO_GW_010_01_MPC=>TS_SPFLI' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250225110645'.                  "#EC NOTEXT
